...
public class PacePalController {
	...
	@ResponseStatus(code = HttpStatus.CREATED)
	public PacepalSong addSongToPlaylist(@PathVariable Long songId, @RequestBody PacepalSong songData) {
		log.info("Adding song to playlist with ID {}:{}", songId, songData);
		return pacepalService.saveSong(songId, songData);
	}
